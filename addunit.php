...
<body>
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Add Unit</h3>
        <div class="row mt" id="showtable">
          <div class="col-lg-12">
            <div class="content-panel" style="padding: 25px;">
              <div class="row">
                <div class="col-md-12">
                    <button type="button" id="button1" class="btn btn-success" onclick="addTax()" style="float:right;margin-bottom: 5px;"> New UNIT</button>
                </div>
              </div>
        ...
        <div class="row" id="showform" style="display:none;">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Add Unit</h4>
              <form class="form-horizontal style-form" method="get">
                ...
                <div class="form-group">
                  <label>Unit</label>
                    ...
                    <input type="text" class="form-control" id="unitval" >
                  </div>
                </div>
                </div>
                <div class="row">
  ...
  <script src="javascript/getunit.js"></script>
  <script src="javascript/addunit.js"></script>
